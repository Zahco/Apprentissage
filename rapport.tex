...
\section{Proposition}
  ...
  \paragraph{}
	...
	\begin{tikzpicture}
	\begin{axis}[
	    title={Évolution du taux moyen de réussite d'un joueur \textbf{hard} avec réduction du poids},
	    ylabel={Taux de réussite en pourcentage },
	    xlabel={Nombre de parties},
	    ymin=0, ymax=100,ytick={0,20,40,60,80,100},
	    xmin=0, xmax=7,xtick={0,1,2,3,4,5,6,7},
	...
	\addplot[color=red,mark=square,]
	    coordinates {(0,50)(1,52)(2, 81)(3, 88)(4, 97)(5, 99)(6, 99.7)(7, 99.8)};
	\addplot[color=blue,mark=square,]
	    coordinates {(0,0)(1,53)(2, 83)(3, 90)(4, 97)(5, 98)(6, 99)(7, 99)};
